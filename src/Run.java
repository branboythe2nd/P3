...
public class Run {
     ...
     *
     * @param input the array of records representing the run
     */
     ...
     *
     * @param record the array of Record objects to set as this run's records
     */
     ...
     *
     * @param lastEle the Record to set as the last element of the run
     */
    ...
    /**
     * Returns the current record in the run, representing the most recently accessed element.
     *
    ...
    /**
     * Sets the current record in the run, usually the last accessed or inserted record.
     *
     * @param current the Record to set as the current record
     */
    ...
    /**
     * Sets the current position within the run, typically pointing to the next record to be accessed.
     *
     * @param pos the integer position to set as the current position in the run
     */
